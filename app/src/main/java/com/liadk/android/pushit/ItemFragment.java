    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseListener = mDatabaseManager.addItemsListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                new EventsLogger(getActivity()).log("item_is_owner1", "is_auth_null", mAuth.getCurrentUser() != null, "is_user_null", mUser != null, "user_status", (mUser != null) && mUser.getStatus(), "is_id_equal", (mUser != null && mUser.getStatus()) && mItem.getOwnerId().toString().equals(mUser.getPageId()), "is_owner", mIsOwner);
            }
        ...
        mDatabaseManager.addUsersSingleEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mIsOwner = mItem != null && mUser != null && mUser.getStatus() && mItem.getOwnerId().toString().equals(mUser.getPageId());
                new EventsLogger(getActivity()).log("item_is_owner2", "is_auth_null", mAuth.getCurrentUser() != null, "is_user_null", mUser != null, "user_status", (mUser != null) && mUser.getStatus(), "is_id_equal", (mUser != null && mUser.getStatus()) && mItem.getOwnerId().toString().equals(mUser.getPageId()), "is_owner", mIsOwner);
            }
